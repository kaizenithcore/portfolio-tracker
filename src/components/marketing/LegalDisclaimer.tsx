export function LegalDisclaimer() {
  return (
    <footer className="border-t border-hairline bg-paper py-8">
      <p className="mx-auto max-w-2xl px-4 text-center font-mono text-xs leading-relaxed text-stone">
        ...
        estimaciones propias basadas en fuentes públicas y pueden no reflejar el
        precio real de reventa de tu botella.
      </p>
    </footer>
  )
}
